...
The HED JavaScript library is a JavaScript validator for HED (Hierarchical Event Descriptor) annotations for
...
The library supports full validation of HED in
[BIDS datasets](https://bids-specification.readthedocs.io/en/stable/) under the BIDS validator 2.0.
A sample usage can be found in the BIDS validator in
...
The library can be used in a Node.js environment to validate HED annotations.
You must install the npm package and require it:
