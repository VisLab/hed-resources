...
| *A && B*<br/>Match if both *A* and *B* <br/>are matched. Same<br>as comma notation.           | *Event* and *Sensory-event* | *Event*, *Sensory-event*<br/>*Sensory-event*, *Event*<br/>(*Event*, *Sensory-event*)                                 |                                                                                                       |
